...
public class Module6 {
    ...
    public static void main(String[] args) {
        ...
        // Задание №2
        System.out.println("2) " + translateWord("Apple"));
        System.out.println("2) " + translateWord("flag"));
        System.out.println("2) " + translateSentence("I like to eat honey waffles."));

        // Задание №3
        System.out.println("3) " + validColor("rgb(255,256,255)"));

        // Задание №4
        System.out.println("4) " + stripUrlParams("https://edabit.com?a=1&b=2&a=2", new String[]{}));

        // Задание №5
        System.out.println("5) " + Arrays.toString(getHashTags("Why You Will Probably Pay More for Your Christmas Tree This Year")));
        ...
        // Задание №8
        System.out.println("8) " + convertToRoman(3999));
